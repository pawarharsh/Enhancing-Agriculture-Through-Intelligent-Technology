...
<?php require ('fheader.php');  ?>
 ...
 <script>
  window.addEventListener("load", function() {
    const endpoint = "https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=68057dfa97bf47e599412817ee9275ad";
    fetch(endpoint)
    .then(response => {
      if (!response.ok) {
...
<div class="container-fluid ">
	...
	error_reporting(E_ERROR | E_PARSE);
        ...
        $url="https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=68057dfa97bf47e599412817ee9275ad";   //Your API KEY
